<template>
<el-dialog :title="lang.modal.properties.title" ref="fmModal" :visible.sync="showModal" width="30%" :before-close="hideModal">
    ...
    <div class="modal-content fm-modal-properties">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-1 text-right">
                    <i v-on:click="copyToClipboard(selectedItem.basename)" v-bind:title="lang.clipboard.copy" class="far fa-copy" />
                </div>
            </div>
            <div class="row">
            ...
            <template v-if="selectedItem.type === 'file'">
                <div class="row">
                    ...
                    <div class="col-1 text-right">
                        <i v-on:click="copyToClipboard(bytesToHuman(selectedItem.size))" v-bind:title="lang.clipboard.copy" class="far fa-copy" />
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <span v-else>
                            <button v-on:click="getUrl" type="button" class="btn btn-sm btn-light">
                                <i class="far fa-sm fa-link" /> Get URL
                            </button>
                        </span>
                    </div>
            ...
            <template v-if="selectedItem.hasOwnProperty('timestamp')">
                <div class="row">
                    ...
                    <div class="col-1 text-right">
                        <i v-on:click="copyToClipboard(timestampToDate(selectedItem.timestamp))" v-bind:title="lang.clipboard.copy" class="far fa-copy" />
                    </div>
                </div>
            </template>
