<template>
<el-dialog :title="lang.modal.zip.title" ref="fmModal" :visible.sync="showModal" width="30%" :before-close="hideModal">
    <div class="modal-body">
        <label for="fm-zip-name">{{ lang.modal.zip.fieldName }}</label>
        <div class="input-group mb-3">
            <input type="text" class="form-control" id="fm-zip-name" v-focus v-bind:class="{'is-invalid': archiveExist}" v-model="archiveName" v-on:keyup="validateArchiveName">
    ...
    <div slot="footer" class="dialog-footer">
        <el-button class="btn btn-info" v-bind:disabled="!submitActive" v-on:click="createArchive">{{ lang.btn.submit }}
        </el-button>
