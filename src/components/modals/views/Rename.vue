<template>
<el-dialog :title="lang.modal.rename.title" ref="fmModal" :visible.sync="showModal" width="30%" :before-close="hideModal">

    <div class="modal-body">
        <div class="form-group">
            <label for="fm-input-rename">{{ lang.modal.rename.fieldName }}</label>
            <input type="text" class="form-control" id="fm-input-rename" v-focus v-bind:class="{'is-invalid': checkName}" v-model="name" v-on:keyup="validateName">
    ...
    <div slot="footer" class="dialog-footer">
        <el-button type="info" v-bind:disabled="submitDisable" v-on:click="rename">{{ lang.btn.submit }}
        </el-button>
