<template>
<el-dialog :title="lang.modal.upload.title" ref="fmModal" :visible.sync="showModal" width="30%" :before-close="hideModal">

    <div class="modal-body">
        <div class="fm-btn-wrapper" v-show="!progressBar">
            <!--el-button type="button" class="btn btn-secondary btn-block">
        ...
        <div class="fm-upload-list" v-if="countFiles">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" id="uploadRadio1" type="radio" name="uploadOptions" value="0" checked v-model="overwrite">
                    <label class="form-check-label" for="uploadRadio1">
                        {{ lang.modal.upload.skip }}
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" id="uploadRadio2" type="radio" name="uploadOptions" value="1" checked v-model="overwrite">
        ...
        <div class="fm-upload-info">
            ...
            <div class="progress" v-show="countFiles">
                <div class="progress-bar progress-bar-striped bg-info" role="progressbar" v-bind:aria-valuenow="progressBar" aria-valuemin="0" aria-valuemax="100" v-bind:style="{width: progressBar + '%' }">
                    {{ progressBar }}%
                </div>
            </div>
        </div>
    ...
    <div slot="footer" class="dialog-footer">
        <el-button class="btn" v-bind:class="[countFiles ? 'btn-info' : 'btn-light']" v-bind:disabled="!countFiles" v-on:click="uploadFiles">{{ lang.btn.submit }}
        </el-button>
